...
var WxOpenLaunchWeappWrap = function WxOpenLaunchWeappWrap(_ref) {
  var children = _ref.children,
      username = _ref.username,
      path = _ref.path,
      launchCallback = _ref.launchCallback;
  var weappRef = (0, _react.useRef)(null);
  ...
  (0, _react.useEffect)(function () {
    if (wx.ready && weappRef.current) {
      ...
      var currentRef = weappRef.current;
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: _styles["default"].openTagWrap
  }, children, /*#__PURE__*/_react["default"].createElement("wx-open-launch-weapp", {
    ref: weappRef,
    "class": _styles["default"].launchBtn,
    username: username,
    path: path
...
var _default = WxOpenLaunchWeappWrap;
